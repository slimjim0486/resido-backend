...
def _sample_events() -> list[dict]:
    ...
    raw = [
        ...
        {
            "title": "Hatta Dam & Mountain Lodge Weekend",
            "description": "A short Dubai-to-Hatta reset with kayaking, mountain views, and an overnight lodge stay.",
            "category": "getaways",
            "venue": "Hatta",
            "area": "Hatta",
            "url": "https://www.visitdubai.com/sample/hatta-weekend-getaway",
